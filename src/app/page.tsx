...
const ContentCard = ({ type, title, author, href, icon }: { type: string, title: string, author: string, href: string, icon: React.ReactNode }) => (
  <Link href={href} className="block bg-gradient-to-tr from-indigo-50 to-white dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
...
>
  ...
  <div className="hidden md:block flex-1 relative">
    ...
    />
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-amber-500 text-white">
