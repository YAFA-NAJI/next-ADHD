...
<<<<<<< HEAD
        <div className="bg-linear-to-tr from-indigo-400 to-emerald-400 p-4 rounded-full mb-4">
=======
...
<<<<<<< HEAD
                        <ClipboardList className="w-5 h-5 text-amber-500 mr-3 mt-1 shrink-0" />
=======
...
<<<<<<< HEAD
          <div className="mx-auto w-32 h-32 rounded-full bg-linear-to-tr from-indigo-400 to-emerald-400 flex items-center justify-center shadow-xl mb-6 animate-bounce">
=======
...
>>>>>>> 48f0b8939c07e93bfbbfa9709e465889d951542d
        ...
        {/* What is ADHD */}
<<<<<<< HEAD
        <section id="what-is-adhd" className="mb-20 p-8 rounded-2xl shadow-lg bg-linear-to-r from-indigo-50 via-indigo-100 to-indigo-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 transition-colors">
=======
...
<<<<<<< HEAD
            ...
            <div className="bg-green-100/50 dark:bg-green-900/20 p-4 rounded-lg flex items-start gap-4">
              <CheckCircle className="w-6 h-6 text-green-500 hrink-0 mt-1" />
